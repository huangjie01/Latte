...
public class RestClient {
    ...
    public static RestClientBuidler buidler() {
        return new RestClientBuidler();
    }
    ...
    private void request(HttpMethod httpMethod) {
        ...
        switch (httpMethod) {
            case GET:
                call = restService.get(URL, PARMASl);
                break;
            case POST:
                call = restService.post(URL, PARMASl);
                break;
            case DELETE:
                call = restService.delete(URL, PARMASl);
                break;
            case UPLOAD:
                ...
                call = restService.upload(URL, file);
                break;
            case PUT:
                call = restService.put(URL, PARMASl);
                break;
            case DOWNLOAD:
                break;
            case POST_RAW:
                restService.postRaw(URL, BODY);
            default:
                break;
        }
        if (call != null) {
